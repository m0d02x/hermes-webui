...
const APP_TITLEBAR_KEYS = {
  ...
  memory: 'tab_memory', workspaces: 'tab_workspaces', library: 'tab_library',
  profiles: 'tab_profiles', todos: 'tab_todos', insights: 'tab_insights', logs: 'tab_logs', settings: 'tab_settings',
};
const MAIN_VIEW_PANELS = ['settings','skills','memory','tasks','kanban','workspaces','library','profiles','insights','logs','plugin'];
...
async function switchPanel(name, opts = {}) {
  ...
  if (nextPanel === 'library') await loadLibrary();
...
async function _profileSwitchPanelLoad(){
  ...
  if (_currentPanel === 'library') await loadLibrary();
}
